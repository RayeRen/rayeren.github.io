...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICoSR</div><img src='images/icosr.pdf' alt="sym" width="100%"></div></div>
...
- The experimental results illustrate that for more than 80% of the testing pair images, the proposed method is capable of refining the positioning error within 5 pixels, which meets the needs of UAV localization and is superior to other popular methods.
